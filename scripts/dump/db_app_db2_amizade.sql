...
CREATE TABLE `amizade` (
  ...
  UNIQUE KEY `Amizade_leitor1_leitor2_uq` (`leitor1`,`leitor2`),
  KEY `leitor2_amizade_fk` (`leitor2`),
  CONSTRAINT `leitor1_amizade_fk` FOREIGN KEY (`leitor1`) REFERENCES `leitor` (`leitor_id`),
  CONSTRAINT `leitor2_amizade_fk` FOREIGN KEY (`leitor2`) REFERENCES `leitor` (`leitor_id`)
...
INSERT INTO `amizade` VALUES (8,1),(6,3),(8,4),(4,7),(5,9);
